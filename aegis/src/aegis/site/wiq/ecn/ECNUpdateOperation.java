...
public class ECNUpdateOperation extends AthenaOperation {
	private TCComponentItem item;
	private String[] columns;

	public ECNUpdateOperation(Athena athena, TCComponentItem item, Hashtable hashtable, String[] columns) {
		super(athena);
		this.item = item;
	...
	private void setProperties(TCComponentItem item) throws TCException {
		for (int i = 0; i < columns.length; i++) {
			...
			String[] information = ResourceService.getStrings("ECNPanel", columns[i]);
